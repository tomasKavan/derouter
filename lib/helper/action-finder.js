  ...
  for (let i = pathArr.length; i > 0; i--) {
    ...
    try {
      ...
      if(keyPath.length){
        ...
        if(actionModule.__esModule === true && typeof actionModule.default === 'function'){
          actionModule = actionModule.default
        } else if(actionModule.__esModule === true && typeof actionModule.default !== 'function'){
          throw 'action is not a function or module does not have default export'
        }
      }
