...
/**
 * Parse function. Create a dictionary with all actions for each routes
...
function parse(config) {
  ...
  keys.forEach(key => {
    ...
    res.handler = parseHandler(config[key].queue)
    res.middleware = config[key].middleware
...
/**
 * Parse route and HTTP method from given string
 *
